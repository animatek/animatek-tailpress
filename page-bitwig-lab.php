...
<main id="primary" class="bg-slate-100 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
    ...
    get_template_part('template-parts/brevo-locker', null, [
        'form_action'  => 'https://a2fe0a0a.sibforms.com/serve/MUIFAOTAu3dD3XV99X__NrZf0gPI98ZRU8rLYa3QKa89c6CXoInqc3veK76j9vosdVQeqTFu4oBT-mFrhe_AT_BS-l3e-xJV_5_emKFnc2qhqE5AHQH8B1cRDW7ZTyzcCFso2CL1SxiJI8IknkP39P9Y0L8zAPtFjXrdbJaYyckOWj9kzJ6Hu3xx8CWfSiIF0QuJkLXL-dmVwsLQ',
        'storage_key'  => 'bitwig_lab_unlocked',
        'title'        => 'Desbloquea la guía completa de Bitwig Lab',
        'description'  => 'Introduce tu email para acceder <strong>GRATIS</strong> al Bitwig Starter Pack. Desbloqueo inmediato. Solo te enviaremos recursos de Bitwig, nada de spam.',
        'email_label'  => 'Introduzca su dirección de e-mail para ver el contenido',
        'email_help'   => 'Introduce tu dirección de e-mail para suscribirte. Ej.: abc@xyz.com',
        'extra_hidden' => ['html_type' => 'simple'],
    ]);
    ?>
