...
function animatek_nme_render_page( string $locale = 'es' ): void {
    ...
    $copy = $is_en ? [
        ...
        'beta_title' => 'Beta log',
        'beta_date' => '0.11.0 · July 24, 2026',
        'teaser_title' => 'What is coming next',
        'teaser' => 'The Patch Mutator, the extra themes and the pop-out slot windows all shipped. What is next is depth rather than breadth: an editor-side meta-modulation layer, more work on the plugin build, and whatever the hardware testing on real racks turns up. Animatek NME is not just about opening old patches again; it is about making the Nord Modular G1 comfortable in a modern setup.',
        ...
        'beta_title' => 'Beta log',
        'beta_date' => '0.11.0 · 24 julio 2026',
        'teaser_title' => 'Lo próximo',
        'teaser' => 'El Patch Mutator, los temas nuevos y las ventanas de slot ya están fuera. Lo próximo va de profundidad más que de anchura: una capa de meta-modulación en el editor, más trabajo en la versión plugin, y lo que vaya saliendo de las pruebas en racks reales. Animatek NME no busca solo volver a abrir patches antiguos; quiere convertir el Nord Modular G1 en un instrumento cómodo dentro de un setup moderno.',
    ...
    $beta_items = $is_en ? [
        'Multi-slot editing in pop-out windows - right-click a slot row to edit it in its own window, with its own canvas, Inspector, undo history and live synth updates.',
        ...
        'Edición multi-slot en ventanas propias - clic derecho en una fila de slot para editarlo en su propia ventana, con su canvas, Inspector, historial de deshacer y actualizaciones en vivo del synth.',
